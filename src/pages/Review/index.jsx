...
export default function ReviewPage() {
  const table3Columns = React.useMemo(() => {
    ...
    return [
      table3ColumnHelper.accessor("rowone", {
        cell: (info) => (
      ...
      table3ColumnHelper.accessor("customerone", {
        cell: (info) => (
      ...
      table3ColumnHelper.accessor("reviewtwo", {
        cell: (info) => (
      ...
      table3ColumnHelper.accessor("totalspent", {
        cell: (info) => (
          <div className="flex flex-col items-start justify-start gap-2.5">
            <Heading size="lg" as="h1" className="mt-[18px]">
              {info?.getValue?.()}
            </Heading>
            <RatingBar
              value={4}
      ...
      table3ColumnHelper.accessor("update", {
        cell: (info) => (
